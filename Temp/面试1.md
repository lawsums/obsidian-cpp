...
### 0.1.1 如何通过 QFileDialog 加载图片，然后借助 QPixmap 实现图片压缩展示的功能？
...
### 0.1.2 员工信息管理项目效率提升 70%、可容纳 100 个员工消息存储，如何判断这个指标？
- **效率提升**：
...
### 0.1.5 网盘项目支持 2 GB 文件传输，是否支持分片续传和校验？
- **分片续传**：
...
### 0.1.7 文件队列功能怎么实现？如何可视化显示在前端界面中？
- **队列实现**：
