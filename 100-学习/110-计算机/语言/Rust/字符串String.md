...
#### 0.7.4.2 2、remove —— 删除并返回字符串中指定位置的字符
...
#### 0.7.4.3 3、truncate —— 删除字符串中从指定位置开始到结尾的全部字符
...
### 0.7.5 连接 (Concatenate)

#### 0.7.5.1 1、使用 `+` 或者 `+=` 连接字符串
